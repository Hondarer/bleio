...
class Program
{
    static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            await client.SetSerialLedPatternAsync(pin: 18, ledIndex: 1, pattern: BleioClient.SerialLedPattern.Flicker1, ptnParam1:128, ptnParam2: 128);
            await client.SetSerialLedPatternAsync(pin: 18, ledIndex: 2, pattern: BleioClient.SerialLedPattern.Flicker1, ptnParam1:128, ptnParam2: 128);
            ...
            // 炎
            await client.SetSerialLedColorAsync(18, 1, 255, 0, 0);
            await client.SetSerialLedPatternAsync(pin: 18, ledIndex: 1, pattern: BleioClient.SerialLedPattern.Flicker3, ptnParam1: 128, ptnParam2: 128);
