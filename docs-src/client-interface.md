...
- **パラメータ共有**: 同じ GPIO の FLICKER1 LED すべてが速度 (param1) と変化幅 (param2) を共有します。最後に処理された FLICKER1 LED のパラメータが GPIO 全体に適用されます
- **推奨設定**: 同一 GPIO の FLICKER1 LED には同じ param1 と param2 を設定することを推奨します
...
- **速度パラメータ (param1)**: 値が小さいほどゆっくり、大きいほど速くゆらめきます (デフォルト: 128)
  - FLICKER1: GPIO 全体で共有 (最後に処理された値を使用)
  - FLICKER2/3: LED ごとに独立
- **変化幅パラメータ (param2)**: 値が小さいほど控えめ、大きいほど激しくゆらめきます (デフォルト: 128)
  - FLICKER1: GPIO 全体で共有 (最後に処理された値を使用)
  - FLICKER2/3: LED ごとに独立
