...
| 4 | PATTERN_FLICKER | 炎のゆらめきパターン (基準色の明度と色相をランダムに変動) |
...
- **独立した挙動**: 各 LED は独立した疑似乱数生成器 (LCG: Linear Congruential Generator) を持ち、互いに同期せずに独立してゆらめきます
...
- **非対称ローパスフィルタ**: 明るくなるときはゆっくり (係数 × 0.7)、暗くなるときは速め (係数 × 1.2) に変化します。これにより、炎のゆらめきがより自然に見えます
- **炭火下限**: 消灯に見えない最低明度として、基準明度の約 26% を下限とします。完全に消灯することなく、常に炭火のように光り続けます
